...
c                                                                      c
c     File 'dirhb.par' is casted to Fortran module 'dirhbpar.mod'.     c
c                                                                      c
...
c
c======================================================================c
c     Relativistic Hartree-Bogoliubov theory in axially symmetric basis
...
c-----Reading parameters which determine dimensions of arrays/matrices.
      ...
      read(tape,*);
      read(tape,*);
      read(tape,'(19x,i12)') NNGH;
      read(tape,'(19x,i12)') NNGL;
      read(tape,*);
      read(tape,*);
      read(tape,*);
      read(tape,*);
      ...
      call assert( NNGH.ge.20        , 'NGH has to be at least 20'   );
...
c-----Calculating NTX, KX, MVX, MVTX (Tamara).
...
c=======================================================================c
      ...
      read( intape , * );read( intape , * );read( intape , * );
      read( intape , * );read( intape , * );read( intape , * );
      read( intape , * );read( intape , * );
      read( intape , '(19x,i12)' ) i_pairing;
